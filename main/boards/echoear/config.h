...
#if SELECT_BOARD == PCB_VERSION_V1_0
...
#define TOUCH_SLIDER_ENABLED           0

#define QSPI_PIN_NUM_LCD_RST           GPIO_NUM_3
#define QSPI_LCD_RST_ACTIVE_HIGH       0

#else
#define UART1_TX                       GPIO_NUM_5
#define UART1_RX                       GPIO_NUM_4

#define TOUCH_PAD1                     GPIO_NUM_7
#define TOUCH_PAD2                     GPIO_NUM_6
#define TOUCH_SLIDER_ENABLED           1

#define QSPI_PIN_NUM_LCD_RST           GPIO_NUM_47
#define QSPI_LCD_RST_ACTIVE_HIGH       1
#endif
